...
mh.multiply(2).multiply(mh.Pi).result(); //Keliling Lingkaran dengan jari jari 7 => 2 x Pi x r = 44
mh.x = 7; //set jari jari 7
// console.log(`nilai sekarang : ${mh.x}`);
mh.exponent(2).multiply(mh.Pi).result(); //Luas Lingkaran dengan jari jari 7 => Pi x r pangkat 2 = 154
mh.x = 4;
// console.log(`nilai sekarang : ${mh.x}`);
mh.exponent(3).result(); // 4 pangkat 3 = 64
mh.square().result(); // akar pangkat 2 dari 64 = 8
